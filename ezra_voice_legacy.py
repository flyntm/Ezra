...
def transcribe(audio):
    ...
    with suppress_stderr_fully():
        segments, _ = model.transcribe(
            "temp.wav", language="en", beam_size=5, vad_filter=True
        )
...
# =========================
def speak(text):
    print("***** EZRA_VOICE SPEAK FUNCTION *****")
    print(f"Ezra: {text}")
    ...
    result = os.system(f"aplay -D {SPEAKER_DEVICE} temp.wav")
